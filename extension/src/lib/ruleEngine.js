...
const FIELD_RULES = [
  ...
  { key: 'currentJobTitle',   keywords: ['job title', 'designation', 'position', 'role', 'current role'] },
  { key: 'currentCompany',    keywords: ['company', 'employer', 'organization', 'current company'] },
  ...
  { key: 'highestDegree',     keywords: ['degree', 'qualification', 'education level'] },
  { key: 'fieldOfStudy',      keywords: ['field of study', 'major', 'specialization', 'branch'] },
  { key: 'university',        keywords: ['university', 'college', 'institution'] },
  { key: 'graduationYear',    keywords: ['graduation year', 'passed out', 'batch'] },
